...
namespace votes
{
    public  class OleDbHelper
    {
        ...
        // Disconnected  
        /// <summary>
        /// performs SELECT sql queries
        /// </summary>
        /// <param name="com">the SQL command</param>
        /// <param name="tableName">the table name</param>
        /// <returns>the result of the select query</returns>
        ...
        //Connected
        /// <summary>
        /// performs UPDATE, DELETE, INSERT queries
        /// </summary>
        /// <param name="sql">the sql command</param>
        /// <returns>the amount of lines affected</returns>
